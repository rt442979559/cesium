  ...
  const czml = [
    ...
    },
    {
      ...
      position: {
        ...
        cartographicDegrees: [
          0, 120.6782316885373, 27.982364756128142, 0, //  4个参数为一组,分别代表:与上个节点的时间差、经度、维度、高度
          10, 120.68511016819569, 27.982037185311256, 0,
          20, 120.68508256961154, 27.98475613188479, 0,
          30, 120.68704734902259, 27.984764234757833, 0,
          40, 120.68704907775131, 27.986920015802216, 0,
          50, 120.69442436198622, 27.986892322552837, 0,
          60, 120.69477478478413, 27.98104413197967, 0,
          70, 120.7184264153452, 27.98048282195917, 0
        ]
      }
    }
...
function setView() {
  ...
  viewer.camera.setView({
    destination: Cesium.Cartesian3.fromDegrees(120.6852797457469, 27.983078486746134, 8000),
    orientation: {
